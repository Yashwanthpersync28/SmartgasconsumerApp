...
// export const MeterDropdownComponent = ({key, data, value, setValue, onChangeItem, placeholder, zIndex}) => {
//     const darkMode = useSelector((state)=> state.darkMode)
//     console.log("asdf333asd");
...
//             labelStyle={[styles.fontSize17, darkMode ? styles.white : styles.black,  {left: -10}]}
